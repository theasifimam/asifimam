...
export default function HeroSection2({ isDark = true, theme }) {
  const colors = {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="relative inline-block mt-2 lg:mt-4">
              <motion.span
                ...
                className={`absolute -inset-1 select-none blur-2xl bg-emerald-500 rounded-full`}
              />
          ...
          <motion.div
            variants={itemVars}
            className="flex flex-wrap gap-6 sm:gap-12 mt-10 lg:mt-12 items-center"
          >
            {metrics.map((m, i) => (
          ...
          >
                ...
                <div key={i} className="group">
                  ...
                  >
                    <motion.div
                      ...
                      className={`h-full ${colors.accentBg} group-hover:brightness-125`}
                    />
                  </div>
                </div>
              ))}
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`w-full py-3 lg:py-4 rounded-3xl ${colors.accentBg} text-zinc-950 font-black text-[10px] lg:text-[11px] uppercase tracking-[0.2em] flex items-center justify-center gap-2 transition-all shadow-lg shadow-emerald-500/20`}
              >
      ...
      <motion.div
        ...
        animate={{ opacity: 0.3 }}
        transition={{ delay: 2 }}
        className="absolute bottom-6 lg:bottom-10 left-0 w-full px-6 flex flex-col sm:flex-row justify-between items-center gap-4"
      >
